...
(function () {
  ...
  var navLinks = Array.prototype.slice.call(
    document.querySelectorAll(
      '.nav-links a[href^="#"], .mm-links a[href^="#"]',
    ),
  );
  ...
  function onScroll() {
    ...
    sections.forEach(function (sec) {
      if (
        ...
        var match = navLinks.find(function (a) {
  ...
  var actBtns = Array.prototype.slice.call(
    document.querySelectorAll(".act-btn"),
  );
  var actPanels = Array.prototype.slice.call(
  ...
  /* ---------------- Gallery lightbox ---------------- */
  var masonryItems = Array.prototype.slice.call(
  ...
  lightboxPrev.addEventListener("click", function () {
    openLightbox(
      (currentIndex - 1 + masonryItems.length) % masonryItems.length,
    );
  });
  lightboxNext.addEventListener("click", function () {
    openLightbox((currentIndex + 1) % masonryItems.length);
  });
  document.addEventListener("keydown", function (e) {
  ...
  if (
    ...
    document
      .querySelectorAll("a, button, .dish-card, .masonry-item")
      .forEach(function (el) {
